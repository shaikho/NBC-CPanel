    ...
    public class ActiveAccountController : Controller
    {
        ...
        public ActionResult ActiveCustomerprocess(CustomerRegBankinfo passedmodel)
        {
            ...
            if (passedmodel.Branch != null)
            {
                ...
                if (model.status.ToString().Equals("A"))
                {
                    message = "This Customer is already activated";
                    ModelState.AddModelError("", message);
               ...
               else if (model.status.ToString().Equals("UA"))
                {
                ...
                else if (model.status.ToString().Equals("DE"))
                {
        ...
        [HttpPost]
        public ActionResult AddAcc(CustomerRegBankinfo model)
        {
            if (Session["user_name"] == null)
            {
                return RedirectToAction("Login", "Login");
        ...
        [HttpPost]
        public ActionResult AddAccprocess(CustomerRegBankinfo passedmodel)
        {
            if (Session["user_name"] == null)
            {
                return RedirectToAction("Login", "Login");
