...
namespace AljazeeraCPanel.Controllers
{
    ...
    public class ChqRequestController : Controller
    {
        ...
        protected PdfPTable Add_Content_To_PDF(PdfPTable tableLayout)
        {
            ...
            List<ChqRequest> cheques = ds.Chqrequest(Session["user_branch"].ToString()); // ds.ChqrequestReport(adminbranch);
            ...
            Paragraph Title2 = new Paragraph("Cheques Report For " + branchname,
               new Font(Font.FontFamily.HELVETICA, 8, 1, iTextSharp.text.BaseColor.WHITE));
